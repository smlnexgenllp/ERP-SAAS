      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-3xl font-bold text-cyan-300">Planned Orders (MRP)</h1>
          </div>
        </div>
        ...
        <div className="flex justify-end mb-6">
          <button
            onClick={fetchOrders}
            className="bg-gray-800 hover:bg-gray-700 px-5 py-2.5 rounded-xl flex items-center gap-2 transition-colors"
          >
            <RefreshCw size={18} />
            Refresh
          </button>
        ...
        {loading ? (
          ...
          <div className="bg-gray-900/70 rounded-2xl border border-cyan-900/40 overflow-hidden shadow-xl">
                        ...
                        <tr className="hover:bg-gray-800/50 transition-colors">
                          ...
                          <td className="p-4 text-center">
                            <button
                              ...
                              disabled={isDisabled}
                              className={`px-5 py-2 rounded-xl text-sm font-medium flex items-center gap-2 mx-auto transition-all ${
                                isDisabled
