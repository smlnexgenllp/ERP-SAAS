...
class OpportunityViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return Opportunity.objects.filter(
            ...
            "quotations", "sales_orders", "quotations__items"
        ).order_by("-created_at")
...
class SalesOrderViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return SalesOrder.objects.filter(
            opportunity__contact__organization=self.request.user.organization
        ).select_related("opportunity", "quotation", "created_by")
...
class InvoiceViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return Invoice.objects.filter(
            sales_order__opportunity__contact__organization=self.request.user.organization
...
class PaymentViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return Payment.objects.filter(
            invoice__sales_order__opportunity__contact__organization=self.request.user.organization
