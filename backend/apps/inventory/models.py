...
class GRN(models.Model):
    ...
    organization = models.ForeignKey(Organization, on_delete=models.CASCADE)
    po = models.ForeignKey(PurchaseOrder, on_delete=models.PROTECT)
    gate_entry = models.OneToOneField(GateEntry, on_delete=models.PROTECT)
...
class QualityInspection(models.Model):
    gate_entry = models.OneToOneField(GateEntry, on_delete=models.CASCADE)
    ...
    def __str__(self):
        return f"Inspection for {self.gate_entry}"
